...
VALUES 
    (1, 1, 'Это комментарий 1 для поста 1', CURRENT_TIMESTAMP, NULL),
    (1, 1, 'это ответ К комментарию 1', CURRENT_TIMESTAMP, 1),
    (1, 1, 'это ответ К комментарию 2', CURRENT_TIMESTAMP, 1),
    (1, 1, 'это ответ К комментарию 3', CURRENT_TIMESTAMP, 1),
    (1, 1, 'это ответ К ответу комментарию 1 номер 1', CURRENT_TIMESTAMP, 3);
