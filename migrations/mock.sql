...
VALUES 
    (1, 1, 'Это комментарий 1 для поста 1', CURRENT_TIMESTAMP , 1 ),
    (1, 1, 'Это комментарий 2 для поста 1', CURRENT_TIMESTAMP , 1 ),
    (1, 1, 'Это комментарий 3 для поста 1', CURRENT_TIMESTAMP , 2 ),
    (2, 1, 'Это комментарий 1 для поста 2', CURRENT_TIMESTAMP , NULL),
    (2, 1, 'Это комментарий 2 для поста 2', CURRENT_TIMESTAMP , NULL),
    (2, 1, 'Это комментарий 3 для поста 2', CURRENT_TIMESTAMP , NULL),
    (3, 1, 'Это комментарий 1 для поста 3', CURRENT_TIMESTAMP , NULL),
    (3, 1, 'Это комментарий 2 для поста 3', CURRENT_TIMESTAMP , NULL),
    (3, 1, 'Это комментарий 3 для поста 3', CURRENT_TIMESTAMP , NULL),
    (4, 1, 'Это комментарий 1 для поста 4', CURRENT_TIMESTAMP, NULL ),
    (4, 1, 'Это комментарий 2 для поста 4', CURRENT_TIMESTAMP , NULL),
    (4, 1, 'Это комментарий 3 для поста 4', CURRENT_TIMESTAMP, NULL);
